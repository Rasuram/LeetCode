...
class Rank {
    ...
    int visibleNodes(Node root) {
        ...
        res += (visibleNodes(root.left) + visibleNodes(root.right));
        return res;
    }
    ...
    void check(int expected, int output) {
        ...
        char wrongTick = '\u2717';
        if (result) {
            System.out.println(rightTick + " allexamples.Test #" + test_case_number);
        } else {
            System.out.print(wrongTick + " allexamples.Test #" + test_case_number + ": Expected ");
