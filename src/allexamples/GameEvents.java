...
public class GameEvents {
    ...
    public static void main(String[] args) {
        List<String> events1 = Arrays.asList("Name1 12 G", "First last 43 Y");
        List<String> events2 = Arrays.asList("Name3 45+1 S SubName", "Name4 46 G");
        getEventsOrder("EDC", "CDE", events1, events2);
    }
}
