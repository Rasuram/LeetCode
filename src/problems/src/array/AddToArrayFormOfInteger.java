...
public class AddToArrayFormOfInteger {
    public static void main(String[] args) {
        ...
        int[] A = {2, 1, 5};
        System.out.println(a.addToArrayForm(A, 806));
    }

    public ArrayList addToArrayForm(int[] A, int K) {
        String str = "";
        for (int a : A)
            str += a;

        String result = String.valueOf(Integer.parseInt(str) + K);
