 ...
 * <p>Example 1:
 *
 * <p>Input: [1,2,3,4,5] Output: allexamples.Node 3 from this list (Serialization: [3,4,5]) The returned node
 ...
 *
 * <p>Input: [1,2,3,4,5,6] Output: allexamples.Node 4 from this list (Serialization: [4,5,6]) Since the list has
