package problems.src.greedy;
/**
 * Created by gouthamvidyapradhan on 09/04/2019 Suppose allexamples.LeetCode will start its IPO soon. In order
 * to sell a good price of its shares to Venture Capital, allexamples.LeetCode would like to work on some
 * projects to increase its capital before the IPO. Since it has limited resources, it can only
 * finish at most k distinct projects before the IPO. Help allexamples.LeetCode design the best way to maximize
